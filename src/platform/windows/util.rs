...
use winapi::um::winnt::{LANG_NEUTRAL, LPCWSTR, MAKELANGID, SUBLANG_DEFAULT};
...
impl MouseCursor {
    pub(crate) fn to_windows_cursor(self) -> *const wchar_t {
        match self {
            ...
            | MouseCursor::Move
            | MouseCursor::AllScroll => winuser::IDC_SIZEALL,
            MouseCursor::EResize
            | MouseCursor::WResize
            ...
            MouseCursor::NeResize | MouseCursor::SwResize | MouseCursor::NeswResize => {
